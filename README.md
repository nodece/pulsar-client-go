...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/nodece/pulsar-client-go)](https://pkg.go.dev/github.com/nodece/pulsar-client-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/nodece/pulsar-client-go)](https://goreportcard.com/report/github.com/nodece/pulsar-client-go)
[![Language](https://img.shields.io/badge/Language-Go-blue.svg)](https://golang.org/)
[![LICENSE](https://img.shields.io/hexpm/l/pulsar.svg)](https://github.com/nodece/pulsar-client-go/blob/master/LICENSE)
...
Check the Projects page at https://github.com/nodece/pulsar-client-go/projects for
...
```go
import "github.com/nodece/pulsar-client-go/pulsar"
```
...
```
github.com/nodece/pulsar-client-go/oauth2: ambiguous import: found package github.com/nodece/pulsar-client-go/oauth2 in multiple modules
```
...
```
github.com/nodece/pulsar-client-go/oauth2 v0.0.0-20220630195735-e95cf0633348 // indirect
```
